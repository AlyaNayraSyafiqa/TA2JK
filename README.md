...
![PC-A Ping](https://github.com/user-attachments/assets/f80d480c-35cf-4f55-87ec-588257bdc471)

2. **Ping dari PC-B ke PC-A, Switch dan Router**  
![PC-B Ping](https://github.com/user-attachments/assets/c576623f-45cf-4c99-8515-c32fdc21e922)

3. **Ping dari Switch ke PC-A, PC-B dan Router**  
![Switch Ping](https://github.com/user-attachments/assets/bcf06ab6-c6c3-4d83-a063-89a1e794e7e1)

4. **Ping dari Router ke PC-A, PC-B dan Switch**  
![Router Ping](https://github.com/user-attachments/assets/bd837825-cddb-48ab-b4f8-fafb9e347db3)

## Sudah dikonfigurasi

1. **Ping dari Router ke PC-A, PC-B dan Switch**  
![Router Ping](https://github.com/user-attachments/assets/015a7184-d3e3-4fad-8587-8e52253fd754)

2. **Ping dari PC-B ke PC-A, Router dan Switch**  
![PC-B Ping](https://github.com/user-attachments/assets/79ae12fb-912f-44ce-8004-f83c90e9e664)

3. **Ping dari Switch ke PC-A, PC-B dan Router**  
![Switch Ping](https://github.com/user-attachments/assets/d742cd88-d149-42d5-a155-ffaaed8ec2dc)

4. **Ping dari PC-A ke PC-B, Router dan Switch**  
![PC-A Ping](https://github.com/user-attachments/assets/691d0fa0-bdcb-4cbf-9b16-d54def1c9389)  
![PC-A Ping](https://github.com/user-attachments/assets/d521c455-5119-40ae-aed6-72b26277fd2a)
